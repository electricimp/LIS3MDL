...
For an example of this hardware integrated in a reference design, see the [Nora overview](https://electricimp.com/docs/hardware/resources/reference-designs/nora/) in the Electric Imp Dev Center.
...
| --- | --- | --- | --- |
| i2cBus | hardware.i2c | N/A | A pre-configured [I&2up2;C object](https://electricimp.com/docs/api/hardware/i2c/) |
